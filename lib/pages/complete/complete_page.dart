...
import 'bloc/complete_cubit.dart';
import 'bloc/complete_state.dart';
...
class CompletePage extends StatelessWidget {
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: ContentBundle(
                      onRefresh: (_) => context.read<CompleteCubit>().onRefresh(),
  ...
  void _onDeleteTapped(BuildContext context, Task? task) {
    context.read<CompleteCubit>().deleteTask(task);
  }
}
